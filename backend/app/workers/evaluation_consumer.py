...
from app.workers.handlers.evaluation_handle import handle_task



class EvaluationStreamWorker:
    """测评 Redis流消费者
    ...
    async def process_message(self, message: dict):
        ...
        try:
            ...
            worker_logger.exception(
                f"process message failed: {message['id']}"
            )
    ...
    async def run(self):
        """运行消费者"""
        worker_logger.info("stream evaluation consumer start")
